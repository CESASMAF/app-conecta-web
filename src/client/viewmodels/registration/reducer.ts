...
import type { WizardState, WizardAction, DiagnosisEntry } from "./types.ts"
...
function updateSection(
  ...
  switch (section) {
    ...
    case "specificity":
      return { ...state, specificity: { ...state.specificity, [field]: value } }
    case "intake":
...
export function wizardReducer(state: WizardState, action: WizardAction): WizardState {
  switch (action.type) {
    ...
    case "ADD_DIAGNOSIS": {
      const empty: DiagnosisEntry = { code: "", date: "", description: "" }
