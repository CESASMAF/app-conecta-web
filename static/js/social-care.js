...
`,co=d`
  ...
  color: ${h.textMuted};
  margin-left: auto;
`,Gt=({activeTab:e,familyCount:t,onTabChange:n})=>c("nav",{class:lo,children:[c("button",{class:`${Ut} ${e==="familias"?qt:""}`,onClick:()=>n("familias"),type:"button",children:"Familias"}),c("button",{class:`${Ut} ${e==="cadastro"?qt:""}`,onClick:()=>n("cadastro"),type:"button",children:"Cadastro"}),c("span",{class:co,children:[t," familias cadastradas"]})]});var fo=d`
  position: relative;
  display: flex;
  align-items: center;
  width: 100%;
...
`,bo=d`
  ...
  pointer-events: auto;
`,Xt=({lastName:e,firstName:t,memberCount:n,isSelected:r,isOtherSelected:o,onSelect:s})=>{let i=r;return c("div",{class:`${ho} ${o&&!r?yo:""}`,onClick:s,"data-selected":String(r),"data-expanded":String(i),children:[c("span",{class:`${xo} ${r?go:""}`,children:e}),c("span",{class:`${So} ${i?bo:""}`,children:[t," \xB7 ",n," membros"]})]})};var Eo=d`
  display: flex;
...
`,an=()=>c("button",{class:zo,onClick:()=>{globalThis.location.href="/patient-registration"},type:"button","aria-label":"Novo cadastro",children:"+"});var Ko=d`
  display: flex;
  flex-direction: column;
  height: 100vh;
  padding: 0 48px;
