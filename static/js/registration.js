...
`,ur=l`
  ...
  color: ${a.dangerAlt};
  margin-top: 0.25rem;
`,Hn=[{value:"MASCULINO",label:"Masculino"},{value:"FEMININO",label:"Feminino"},{value:"OUTRO",label:"Outro"}],Gn=["Brasileira","Naturalizada","Estrangeira"],Wn=l`
  background: transparent;
  border: none;
  border-bottom: 1.5px solid ${g(a.primary,.15)};
  padding: clamp(0.5rem, 0.4rem + 0.4vw, 0.625rem) 0;
...
`,gr=({fields:e,errors:t,onUpdate:r})=>n("div",{class:Ln,children:[n("div",{children:n(y,{label:"Nome",value:e.firstName,onChange:o=>r("firstName",o),error:t.get("firstName")})}),n("div",{children:n(y,{label:"Sobrenome",value:e.lastName,onChange:o=>r("lastName",o),error:t.get("lastName")})}),n("div",{children:n(y,{label:"Nome Social",value:e.socialName,onChange:o=>r("socialName",o)})}),n("div",{children:n(y,{label:"Nome da Mae",value:e.motherName,onChange:o=>r("motherName",o),error:t.get("motherName")})}),n("div",{children:[n("label",{class:fr,children:"Nacionalidade"}),n("select",{class:k(Wn,t.get("nationality")?Un:void 0),value:e.nationality,onChange:o=>r("nationality",o.target.value),"aria-label":"Nacionalidade",children:[n("option",{value:"",children:"Selecione..."}),Gn.map(o=>n("option",{value:o,children:o}))]}),t.get("nationality")&&n("div",{class:ur,children:t.get("nationality")})]}),n("div",{children:[n("label",{class:fr,children:"Sexo"}),n("div",{class:zn,children:Hn.map(o=>n("button",{type:"button",class:k(Bn,e.gender===o.value?Fn:void 0,t.get("gender")&&!e.gender?Vn:void 0),onClick:()=>r("gender",o.value),"aria-label":`Sexo: ${o.label}`,"aria-pressed":e.gender===o.value,children:o.label}))}),t.get("gender")&&n("div",{class:ur,children:t.get("gender")})]}),n("div",{children:n(y,{label:"Telefone",value:e.phoneNumber,onChange:o=>r("phoneNumber",o)})})]});var Kn=l`
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: clamp(1rem, 0.75rem + 1vw, 1.5rem) clamp(1.25rem, 1rem + 1vw, 1.75rem);
...
`,qn=l`
  ...
  color: ${a.dangerAlt};
  line-height: 1.4;
`,Xn=e=>{let t=e.replace(/\D/g,"").slice(0,11);return t.length<=3?t:t.length<=6?`${t.slice(0,3)}.${t.slice(3)}`:t.length<=9?`${t.slice(0,3)}.${t.slice(3,6)}.${t.slice(6)}`:`${t.slice(0,3)}.${t.slice(3,6)}.${t.slice(6,9)}-${t.slice(9)}`},hr=e=>{let t=e.replace(/\D/g,"").slice(0,8);return t.length<=2?t:t.length<=4?`${t.slice(0,2)}/${t.slice(2)}`:`${t.slice(0,2)}/${t.slice(2,4)}/${t.slice(4)}`},at=e=>e.replace(/\D/g,""),br=({documents:e,errors:t,onUpdate:r})=>{let o=t.get("cpf")===void 0&&t.get("nis")===void 0&&t.get("rgNumber")===void 0&&t.size>0&&t.has("documents");return n("div",{class:Kn,children:[t.get("documents")&&n("div",{class:qn,children:t.get("documents")}),n("div",{children:n(y,{label:"CPF",value:Xn(e.cpf),onChange:i=>r("cpf",at(i)),error:t.get("cpf")})}),n("div",{children:n(y,{label:"NIS",value:e.nis,onChange:i=>r("nis",i),error:t.get("nis")})}),n("div",{children:n(y,{label:"CNS",value:e.cnsNumber,onChange:i=>r("cnsNumber",i),error:t.get("cnsNumber")})}),n("div",{children:n(y,{label:"Data de Nascimento",value:hr(e.birthDate),onChange:i=>r("birthDate",at(i)),error:t.get("birthDate")})}),n("div",{class:Yn,children:"RG (preencha todos ou nenhum)"}),n("div",{children:n(y,{label:"Numero do RG",value:e.rgNumber,onChange:i=>r("rgNumber",i),error:t.get("rgNumber")})}),n("div",{children:n(y,{label:"UF",value:e.rgUf,onChange:i=>r("rgUf",i),error:t.get("rgUf")})}),n("div",{children:n(y,{label:"Orgao Emissor",value:e.rgAgency,onChange:i=>r("rgAgency",i),error:t.get("rgAgency")})}),n("div",{children:n(y,{label:"Data de Emissao",value:hr(e.rgDate),onChange:i=>r("rgDate",at(i)),error:t.get("rgDate")})})]})};var Zn=l`
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: clamp(1rem, 0.75rem + 1vw, 1.5rem) clamp(1.25rem, 1rem + 1vw, 1.75rem);
...
`,Yi=l`
  grid-column: 1 / -1;
`,qi=["Quilombola","Indigena","Ribeirinho","Cigano","Extrativista","Pescador artesanal","Pertencente a comunidade de terreiro","Nenhuma das anteriores"],Dr=({specificity:e,errors:t,onUpdate:r})=>n("div",{class:Wi,children:[n("div",{children:[n("label",{class:Rr,children:"Identidade Social"}),n("select",{class:Ui,value:e.selectedIdentity,onChange:o=>r("selectedIdentity",o.target.value),"aria-label":"Identidade social",children:[n("option",{value:"",children:"Selecione..."}),qi.map(o=>n("option",{value:o,children:o}))]})]}),n("div",{children:n(y,{label:"Descricao",value:e.description,onChange:o=>r("description",o),error:t.get("description")})}),n("div",{class:Yi,children:[n("label",{class:Rr,children:"Observacoes"}),n("textarea",{class:Ki,placeholder:"Informacoes complementares sobre especificidades...","aria-label":"Observacoes sobre especificidades"})]})]});var Xi=l`
  display: grid;
  grid-template-columns: 1fr 1fr;
  gap: clamp(1rem, 0.75rem + 1vw, 1.5rem) clamp(1.25rem, 1rem + 1vw, 1.75rem);
