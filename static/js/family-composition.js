...
`,Io=["Nome","Idade","Sexo","Parentesco","Reside","PcD","Docs","Acoes"],ur=({members:e,onEdit:t,onRemove:r,onSetCaregiver:o})=>c("table",{class:Oo,children:[c("thead",{children:c("tr",{children:Io.map(n=>c("th",{class:_o,children:n},n))})}),c("tbody",{children:e.map((n,s)=>c(pr,{member:n,onEdit:()=>t(s),onRemove:()=>r(n.personId),onSetCaregiver:()=>o(n.personId)},n.personId))})]});var Mo=d`
  position: fixed;
  inset: 0;
...
`,Ho=d`
  ...
  transition: opacity 0.2s;
  &:hover { opacity: 0.9; }
`,dr=({lookups:e,onSave:t,onClose:r,editMember:o})=>{let n=!!o,[s,i]=O(o?.name??""),[l,u]=O(o?.birthDate??""),[f,p]=O(o?.sex??""),[a,h]=O(o?.residesWithPatient??!0),[y,b]=O(o?.hasDisability??!1),[k,A]=O(o?.isPrimaryCaregiver??!1),[L,W]=O(o?.relationshipId??"");return c(He,{onClose:r,maxWidth:"760px",children:[c("h2",{class:Bo,children:n?"Editar Membro":"Adicionar Membro"}),c("div",{class:Lo,children:[c("div",{class:No,children:[c("div",{children:[c("label",{class:pt,children:"Nome *"}),c("input",{class:dt,value:s,onInput:x=>i(x.target.value),placeholder:"Nome completo",disabled:n})]}),c("div",{children:[c("label",{class:pt,children:"Data Nasc. *"}),c("input",{class:dt,type:"date",value:l,onInput:x=>u(x.target.value),disabled:n})]}),c("div",{children:[c("label",{class:pt,children:"Sexo *"}),c("select",{class:zo,value:f,onChange:x=>p(x.target.value),disabled:n,children:[c("option",{value:"",children:"Selecione"}),c("option",{value:"Masculino",children:"Masculino"}),c("option",{value:"Feminino",children:"Feminino"})]})]}),c("label",{class:ut,children:[c("input",{type:"checkbox",checked:a,onChange:()=>h(!a)}),"Reside com paciente"]}),c("label",{class:ut,children:[c("input",{type:"checkbox",checked:y,onChange:()=>b(!y)}),"Pessoa com deficiencia"]}),c("label",{class:ut,children:[c("input",{type:"checkbox",checked:k,onChange:()=>A(!k)}),"Cuidador principal"]}),c("button",{class:Ho,onClick:()=>{if(!s||!l||!f||!L)return;let x=e.find(v=>v.id===L);t({personId:o?.personId??crypto.randomUUID(),name:s,birthDate:l,sex:f,relationshipId:L,relationshipLabel:x?.descricao??"",residesWithPatient:a,hasDisability:y,isPrimaryCaregiver:k,isPR:o?.isPR??!1,requiredDocuments:o?.requiredDocuments??[]})},children:n?"Salvar alteracoes":"Adicionar"})]}),c("div",{class:Fo,children:e.map(x=>c("div",{class:Vo(L===x.id),onClick:()=>W(x.id),children:x.descricao},x.id))})]})]})};var Uo=d`
  font-family: ${g.satoshi};
  font-size: 22px;
  font-weight: ${S.bold};
  color: ${m.background};
